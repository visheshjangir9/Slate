...
/** The Studio workflow a generation was made in. */
...
export interface Generation {
  ...
  retryOf: string | null
  /** Workflow that created it. Null for rows made before this was recorded. */
  workflow?: Workflow | null
  /**
   * The provider's job handle for an asynchronous render on the user's own
   * provider. An identifier only; never a credential.
   */
