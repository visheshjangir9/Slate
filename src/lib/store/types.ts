...
export interface GenerationStore {
  ...
  /**
   * Move every generation from one owner to another. Used once, at sign-in,
   * so work made as a guest in this browser follows the user into the account.
   */
  reassignOwner(from: string, to: string): Promise<number>
